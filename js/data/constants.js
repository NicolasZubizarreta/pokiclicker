...
const ITEMS = {
    ...
    calcium: { name: "Calcium", price: 50000, desc: "Boost DPS permanent +2% (max 10 par Pokémon)", type: "consumable", zone: 0, shop: "mall", noBadgeInflation: true, img: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/calcium.png", invKey: "calcium" },
    ...
    ctJackpot: { name: "CT Jackpot", price: 0, desc: "Gains d'argent +20%", type: "upgrade", zone: 0, shop: "casino", icon: "casino", iconColor: "text-emerald-400" },
