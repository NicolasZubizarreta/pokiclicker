...
function initSlotsReels() {
    const reel1 = document.getElementById('slot-reel-img-1');
    const reel2 = document.getElementById('slot-reel-img-2');
    const reel3 = document.getElementById('slot-reel-img-3');
    if (reel1 && reel2 && reel3 && !reel1.dataset.symbol && !reel2.dataset.symbol && !reel3.dataset.symbol) {
...
function spinSlots(bet) {
    ...
    let stopped = 0;
    const finishSpin = () => {
        const finalSymbols = results.slice();
        let payoutMult = 0;
